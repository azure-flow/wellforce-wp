    ...
    <div class="flex flex-col items-center justify-center justify-center w-full h-full">
        <section class="w-full flex flex-col justify-center items-center pb-16 px-8 md:px-40">
            <div class="w-full max-w-[600px] flex flex-col justify-center items-center gap-2 md:gap-4 xl:gap-8">
                <h2 class="w-full text-center text-white text-[34px] md:text-[2rem] lg:text-[2.5rem] xl:text-[3rem] mb-2 md:mb-4 xl:mb-6 font-normal text-center">
                    Contact
                </h2>
                <span class="w-full h-0.5 bg-white bottom-0 pointer-events-none"></span>
                <p class="max-w-[580px] text-white text-[16px] md:text-[15px] lg:text-[16px] xl:text-[18px] leading-[1.6] text-center">
                    For inquiries regarding experiences and tours in Mie, <br class="hidden md:block">
                    please complete the form below. A member of our team will review your<br class="hidden md:block">
                    request and will be in touch to assist you personally.
                </p>
            </div>
            <div
                class="w-full max-w-[520px] py-14 md:px-12 flex flex-col items-center shadow-none m-auto">
                <?php echo do_shortcode('[contact-form-7 id="af9322f" title="お問い合わせ:EN"]'); ?>
            </div>
        </section>
    </div>
</section>
...
<div id="inquirySentModal" class="hidden fixed inset-0 z-[1000] bg-black/20 flex items-center justify-center opacity-0 pointer-events-none transition-opacity duration-[450ms] [transition-timing-function:cubic-bezier(.7,0,.3,1)]">
    <div class="bg-white shadow-[0_8px_40px_0_rgba(0,0,0,0.10)] relative flex flex-col gap-4 lg:gap-6 items-center py-14 px-8 md:px-16 xl:py-24 max-w-[800px] md:w-[550px] lg:w-[650px] xl:w-full mx-4 modal-content-animate">
        ...
        <!-- Heading -->
        <h2 class="text-[24px] md:text-[28px] lg:text-[30px] xl:text-[36px] font-normal text-[#232323] lg:mb-3 mb-2">Submission Complete</h2>
        <div class="font-garamond text-[#757575] text-[18px] md:text-[20px] lg:text-[24px] xl:text-[28px] text-center font-light mb-2 tracking-tight font-200">Thank you for contacting MIESCAPE.</div>
        <!-- Message Lines -->
        <div class="text-[#757575] text-[16px] md:text-[16px] lg:text-[18px] xl:text-[20px] text-center font-light leading-[1.7] mb-2 max-w-[520px]">
            Thank you for your inquiry. Our team will contact you soon. Please wait for our response.
        </div>
        <!-- Return Link -->
...
<script>
    (function() {
        ...
        document.addEventListener('wpcf7mailsent', function(event) {
            ...
            openContactConfirmModal();
            // Remove hash from URL to keep clean URL
