    ...
    <div
        ...
        <div
            ...
            <p
                ...
                拋開日常的喧囂，來一場不只是走馬看花的旅行吧！<br>
                我們誠摯邀請您，一同前往探尋那能與您的心靈靜靜對話的絕美景色。<br>
                MIEscape 將帶您造訪這片日本精神的發源地——伊勢志摩
        </div>
        <div
            ...
            ?>
                    <div class="w-full flex flex-col <?php echo ($i % 2 === 1) ? 'md:flex-row-reverse' : 'md:flex-row'; ?> justify-between md:items-center gap-8 xl:gap-16">
                        ...
                        <div class="w-full md:w-1/3 flex items-center">
                            <div class="flex flex-col md:gap-4 lg:gap-6 xl:gap-8">
                                <h3
                                    class="text-white text-[17px] md:text-[17px] lg:text-[20px] xl:text-[30px] font-normal mb-3">
                                    <?php the_field('title'); ?>
                                </h3>
        ...
        <div class="w-full max-w-[360px] flex flex-col items-center gap-6 md:gap-10 lg:gap-14 xl:gap-20">
            <div
                ...
                <div class="w-full flex flex-col justify-between items-center">
                    <span
                        class="mt-2 mb-[2px] text-[15px] md:text-[15px] lg:text-[17px] xl:text-[18px]">費用說明</span>
                    ...
                    <div class="w-full text-center">
                        <span
                            ...
                            echo !empty($price) ? nl2br(esc_html($price)) : '<span class="text-[#888]">未定</span>';
                            ?>
                        </span>
                    </div>
                </div>
                <div class="w-full flex flex-col justify-between items-center">
                    <span
                        class="mt-2 mb-[2px] text-[15px] md:text-[15px] lg:text-[17px] xl:text-[18px]">費用包含項目</span>
                    <div class="w-full border-t border-[#C4B28C] my-1"></div>
                    <div class="w-full text-center">
                        <span
                            class="w-full text-white text-[16px] text-center md:text-[16px] lg:text-[18px] xl:text-[19px]">
                            ...
                            echo !empty($includes) ? nl2br(esc_html($includes)) : '<span class="text-[#888]">未定</span>';
                            ?>
                        </span>
                    </div>
                </div>
                <div class="w-full flex flex-col justify-between items-center">
                    <span
                        class="mt-2 mb-[2px] text-[15px] md:text-[15px] lg:text-[17px] xl:text-[18px]">服務語言</span>
                    <div class="w-full border-t border-[#C4B28C] my-1"></div>
                    <div class="w-full text-center">
                        <span
                            class="w-full text-white text-[16px] text-center md:text-[16px] lg:text-[18px] xl:text-[19px]">
                            ...
                            echo !empty($langs) ? nl2br(esc_html($langs)) : '<span class="text-[#888]">未定</span>';
                            ?>
                        </span>
                    </div>
                </div>
                <div class="w-full flex flex-col justify-between items-center">
                    ...
                    <div class="w-full text-center">
                        <span
                            ...
                            echo !empty($min_max) ? nl2br(esc_html($min_max)) : '<span class="text-[#888]">未定</span>';
                            ?>
                        </span>
                    </div>
                </div>
                <div class="w-full flex flex-col justify-between items-center">
                    ...
                    <div class="w-full text-center">
                        <span
                            ...
                            echo !empty($cancel_policy) ? nl2br(esc_html($cancel_policy)) : '<span class="text-[#888]">未定</span>';
                            ?>
                        </span>
                    </div>
                </div>
                <div class="w-full flex flex-col justify-between items-center">
                    ...
                    <div class="w-full text-center">
                        <span
                            ...
                            echo !empty($meeting_place) ? nl2br(esc_html($meeting_place)) : '<span class="text-[#888]">未定</span>';
                            ?>
                        </span>
                    </div>
                </div>
            </div>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3295.7003030186934!2d136.8161375763245!3d34.307180704225004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6005abc3e76f707f%3A0x87eee77a3321cc44!2sEntrada%20Kashikojima%20-%20Ago%20bay%20cruise%2C%20sea%20taxi%20%26%20other%20cruise%20experience!5e0!3m2!1szh-TW!2s!4v1765018786200!5m2!1szh-TW!2s"
                ...
                <section class="accordion flex flex-col gap-6 md:gap-8 lg:gap-10 xl:gap-10">
                    <div class="tab">
                        ...
                        <div class="tab__content">
                            <p>
                                A. 可以的。關於僅包含海女體驗的行程，請參閱本網站的「體驗（Experiences）」頁面。
                                若您希望預約此項體驗，請透過聯絡表單（Contact Form）告知我們。
                            </p>
                        </div>
                    </div>
                    <div class="tab">
                        ...
                        <div class="tab__content">
                            <p>
                                A. 為確保隱私與尊榮感，酒吧的具體地點對外保密。我們將安排專屬船隻，接送您前往這處隱密的私人空間。
                            </p>
                        </div>
                    </div>
                    <div class="tab">
                        ...
                        <div class="tab__content">
                            <p>
                                A. 特別推薦給希望透過在地講述者（Storyteller），親耳聆聽志摩歷史、
                                海女與珍珠故事的旅客，以及渴望尋求與眾不同、深度非凡體驗的貴賓。
                            </p>
                        </div>
                    </div>
                </section>
        ...
        <form class="w-full flex flex-col gap-4 max-w-[560px] items-center">
            <div class="w-full flex flex-col gap-1">
                <label for="name"
                    ...
                    姓名<span class="text-[#c71515]">*</span>
                </label>
            ...
            <div class="w-full flex flex-col gap-1">
                <label for="nationality"
                    class="text-[#181818] text-sm font-normal md:text-[16px] lg:text-[18px] xl:text-[20px]">國籍<span
            ...
            <div class="w-full flex flex-col gap-1">
                <label for="email"
                    class="text-[#181818] text-sm font-normal md:text-[16px] lg:text-[18px] xl:text-[20px]">電子郵件信箱<span
                        class="text-[#c71515]">*</span></label>
            ...
            <div class="w-full flex flex-col gap-1">
                <label for="comments"
                    class="text-[#181818]  font-normal text-sm md:text-[16px] lg:text-[18px] xl:text-[20px]">備註</label>
            ...
            <div class="flex items-center mt-2">
                ...
                <label
                    ...
                    我同意<a href="<?php echo esc_url(home_url('/zh/privacy')); ?>" class="underline">隱私權政策</a>。
                </label>
            </div>
            <button type="submit"
                class="mt-6 w-[80%] bg-[#9E895B] text-white text-[28px] md:text-[34px] tracking-widest -sm hover:bg-[#9b9960] transition">
                送出
            </button>
        </form>
    </div>
