    ...
    <div
        ...
        <div
            ...
            <p
                ...
                日常の喧騒から離れ、ただ眺めるだけではなく、<br>
                あなたの魂に静かに語りかけるような風景を求めて旅に出ませんか。<br>
                MIEscapeは、日本精神の中心地である伊勢志摩へあなたを招待します。
            </p>
        </div>
        <div
        ...
        <div class="w-full max-w-[360px] flex flex-col items-center gap-6 md:gap-10 lg:gap-14 xl:gap-20">
            <div
                ...
                <div class="w-full flex flex-col justify-between items-center">
                    <span
                        class="mt-2 mb-[2px] text-[15px] md:text-[15px] lg:text-[17px] xl:text-[18px]">料金</span>
                ...
                <div class="w-full flex flex-col justify-between items-center">
                    <span
                        class="mt-2 mb-[2px] text-[15px] md:text-[15px] lg:text-[17px] xl:text-[18px]">含まれるもの</span>
                    <div class="w-full border-t border-[#C4B28C] my-1"></div>
                    <div class="w-full text-center">
                        <span
                            class="w-full text-white text-[16px] text-center md:text-[16px] lg:text-[18px] xl:text-[19px]">
                ...
                <div class="w-full flex flex-col justify-between items-center">
                    <span
                        class="mt-2 mb-[2px] text-[15px] md:text-[15px] lg:text-[17px] xl:text-[18px]">対応言語</span>
                    <div class="w-full border-t border-[#C4B28C] my-1"></div>
                    <div class="w-full text-center">
                        <span
                            class="w-full text-white text-[16px] text-center md:text-[16px] lg:text-[18px] xl:text-[19px]">
                ...
                <section class="accordion flex flex-col gap-6 md:gap-8 lg:gap-10 xl:gap-10">
                    <div class="tab">
                        ...
                        <div class="tab__content">
                            <p>
                                A. 海女漁だけの体験も可能です。内容は、「体験」ページをご覧ください。
                                海女漁体験をご希望の場合は、コンタクトフォームからその旨をお送りください。
                            </p>
                        </div>
                    </div>
                    <div class="tab">
        ...
        <form class="w-full flex flex-col gap-4 max-w-[560px] items-center">
            <div class="w-full flex flex-col gap-1">
                <label for="name"
                    ...
                    氏名<span class="text-[#c71515]">*</span>
                </label>
            ...
            <div class="w-full flex flex-col gap-1">
                <label for="nationality"
                    class="text-[#181818] text-sm font-normal md:text-[16px] lg:text-[18px] xl:text-[20px]">国籍<span
            ...
            <div class="w-full flex flex-col gap-1">
                <label for="email"
                    class="text-[#181818] text-sm font-normal md:text-[16px] lg:text-[18px] xl:text-[20px]">メールアドレス<span
                        class="text-[#c71515]">*</span></label>
            ...
            <div class="w-full flex flex-col gap-1">
                <label for="comments"
                    class="text-[#181818]  font-normal text-sm md:text-[16px] lg:text-[18px] xl:text-[20px]">コメント</label>
            ...
            <div class="flex items-center mt-2">
                ...
                <label
                    ...
                    <a href="<?php echo esc_url(home_url('/privacy')); ?>" class="underline">プライバシーポリシー</a>に合意します。
                </label>
            </div>
            <button type="submit"
                class="mt-6 py-1 md:py-[6px] w-[80%] bg-[#9E895B] text-white text-[26px] md:text-[28px] tracking-widest -sm hover:bg-[#9b9960] transition">
                送信する
            </button>
        </form>
    </div>
