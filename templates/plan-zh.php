        ...
        <div class="w-full max-w-[870px] flex flex-col items-center gap-6 md:gap-10 lg:gap-14 xl:gap-20">
            ...
            <script>
                    ...
                    return `
                        <div class="relative bg-white/10 overflow-hidden flex flex-col group max-w-[400px] md:w-full mx-auto " data-categories='${JSON.stringify(exp.categories)}'>
                            ${exp.image && exp.image.url ? `
                                <img loading="lazy" src="${exp.image.url}" alt="Diving with a local Ama diver in Ise-Shima"
                            ...
                            <div class="flex flex-col max-h-[330px] bg-black/40 gap-3 md:gap-1 lg:gap-3 xl:gap-4 absolute bottom-0 left-0 w-full xl:p-6 p-6 md:p-4 lg:p-5 flex flex-col">
                                ...
                                <div class="flex flex-col gap-2 lg:gap-3">
                                    ...
                                    <a href="${exp.permalink}" class="font-mincho flex items-center font-bold tracking-[1.5px] inline-flex items-center gap-3 px-2 md:px-2 lg:px-3 xl:px-4 py-[2px] xl:py-1 text-[#464646] md:text-[12px] lg:text-[14px] xl:text-[15px] bg-white hover:bg-[#9C834E] hover:text-white duration-200 self-start">
                                        <p>查看更多</p>
                                        <i class="fa-solid fa-play text-[10px] md:text-[8px] lg:text-[9px] lg:text-[10px] pt-[1px] lg:pt-[1px] xl:pt-[2px]"></i>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                function renderExperiences(cards) {
                    ...
                    if (cards.length === 0) {
                        container.innerHTML = "<p class='text-white text-lg text-center col-span-2 py-10'>No experiences found for this category.</p>";
                    } else {
            ...
            <div class="w-full flex justify-center">
                <a class="w-[30%] mb-32" href="<?php echo esc_url(home_url('/zh/contact')); ?>">
                    <button
                        class="w-full py-1 bg-[#9E895B] text-white text-center text-[26px] md:text-[28px] lg:text-[30px] xl:text-[34px] tracking-widest hover:bg-[#9f895bcc] transition">
                        聯絡
                    </button>
                </a>
            </div>
