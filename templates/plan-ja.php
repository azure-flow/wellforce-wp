        ...
        <div class="w-full max-w-[870px] flex flex-col items-center gap-6 md:gap-10 lg:gap-14 xl:gap-20">
            ...
            if ($experiences->have_posts()) :
                while ($experiences->have_posts()) : $experiences->the_post();
                    ...
                    $experiences_data[] = array(
                        ...
                        'order' => get_field('order'), // Optional: include the order field if needed
                    );
                endwhile;
                wp_reset_postdata();
            endif;
            ...
            <script>
                        ...
                        <div class="relative bg-white/10 overflow-hidden flex flex-col group max-w-[400px] md:w-full mx-auto " data-categories='${JSON.stringify(exp.categories)}'>
                            ...
                            <div class="flex flex-col max-h-[330px] bg-black/40 gap-3 md:gap-1 lg:gap-3 xl:gap-4 absolute bottom-0 left-0 w-full xl:p-6 p-6 md:p-4 lg:p-5 flex flex-col">
                                ...
                                <div class="flex flex-col gap-2 lg:gap-3">
                                    ...
                                    <a href="${exp.permalink}"
                                        class="flex items-center font-bold tracking-[1.5px]  inline-flex items-center gap-3 px-2 md:px-2 lg:px-3 xl:px-4 py-[2px] md:py-[2px] lg:py-[3px] xl:pt-1 xl:pb-[5px] text-[#464646] md:text-[12px] lg:text-[13px] xl:text-[14px] bg-white hover:bg-[#9C834E] hover:text-white duration-200 self-start">
                                        <p>もっと見る</p>
                                        <i
                ...
                function renderExperiences(cards) {
                    ...
                    if (cards.length === 0) {
                        container.innerHTML = "<p class='text-white text-lg text-center col-span-2 py-10'>このカテゴリの体験は見つかりませんでした。</p>";
                    } else {
            ...
            <div class="w-full flex justify-center">
                <a class="w-[30%] mb-32" href="<?php echo esc_url(home_url('/contact')); ?>">
                    <button
