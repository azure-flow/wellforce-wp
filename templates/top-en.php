...
<section class="relative h-[667px] md:h-[700px] lg:h-[800px] xl:h-[1080px] overflow-hidden">
        ...
        <div class="relative md:mb-4 z-10 select-none">
            <div
                ...
                <div
                    ...
                    <a href="<?php echo esc_url(pll_home_url('zh')); ?>"
                        class="font-mincho w-[48px] lg:w-[52px] xl:w-[58px] h-[28.21px] lg:h-[30.21px] xl:h-[34.21px] flex items-center justify-center bg-[#CDD3D6] text-[#0B1828] transition hover:bg-white hover:underline hover:underline-offset-[6px] hover:decoration-[#0B1828]">
                        繁體字
                    </a>
                </div>
    ...
    <div class="relative flex justify-center w-full h-full px-8 z-[1]">
        <div
            ...
            <h2 class="text-white text-[50px] md:text-[28px] lg:text-[52px] xl:text-[70px]">MIEscape</h2>
            <hr>
            <h3 class="text-white text-[16px] md:text-[15px] xl:text-[23px] opacity-70 tracking-wider text-right">
                Your Gateway to the Authentic Soul<br> of Ise-Shima.
            </h3>
        </div>
    </div>
    <div
...
<section
    ...
    <div
        ...
        <h1 class="text-white text-[28px] lg:text-[36px] xl:text-[40px]">
            <span class="text-[20px] lg:text-[24px] xl:text-[28px] block">A Journey into the</span>
            UNSEEN HEART
            <span class="text-[20px] lg:text-[24px] xl:text-[28px] block">of Japan</span>
        </h1>
        <p class="text-white text-[12px] lg:text-[13px] xl:text-[17px] leading-[2] pb-8">
            Leave the everyday noise behind and venture into the <br>
            landscape that will not just please your eyes but <br>
            speaks to your soul. MIEscape is your invitation <br>
            to the spiritual heartland of Japan: Ise-Shima. <br>
        </p>
    </div>
</section>
...
<section
    ...
    <div class="flex flex-col max-w-[380px] gap-[60px] md:ml-[300px]">
        <p class="text-white text-[12px] lg:text-[14px] xl:text-[17px] leading-[2] text-right">
            This is a sacred realm where deities dwell, and <br class="md:block hidden">
            where timeless nature and human life are woven <br class="md:block hidden">
            into a single, breathtaking tapestry. <br class="md:block hidden">
            Discover an authentic Japan, far beyond <br class="md:block hidden">
            the reach of ordinary travel. <br class="md:block hidden">
        </p>
    </div>
</section>
<section
    ...
    <div class="flex flex-col max-w-[1000px] gap-[60px] mx-auto w-full">
        <div class="flex flex-col gap-4 xl:gap-6 w-full mb-4">
            <h2 class="font-garamond text-white text-[30px] md:text-[28px] lg:text-[32px] xl:text-[34px]">Our Experience</h2>
            <hr>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <a href="<?php the_permalink(); ?>"
                                class="flex items-center font-garamond font-bold tracking-[1.5px]  inline-flex items-center gap-3 px-2 md:px-2 lg:px-3 xl:px-4 py-[3px] md:py-[2px] xl:py-1 text-[#464646] md:text-[12px] lg:text-[14px] xl:text-[15px] bg-white hover:bg-[#9C834E] hover:text-white duration-200 self-start">
                                <p>view more</p>
                                <i
                                    class="fa-solid fa-play text-[10px] md:text-[8px] lg:text-[9px] lg:text-[10px] pt-[2px] lg:pt-[2px] xl:pt-[2px]">
                                </i>
                            </a>
                        </div>
                    </div>
...
<section class="bg-[#08111b] py-20 flex justify-center items-center px-6">
    <div class="max-w-[600px] w-full mx-auto flex flex-col items-center justify-center text-center gap-8">
        ...
        <div class="w-full flex justify-center">
            <a href="<?php echo esc_url(home_url("en/tour")); ?>" class="flex items-center font-garamond font-bold tracking-[1.5px]  inline-flex items-center gap-3 px-2 md:px-2 lg:px-3 xl:px-4 py-[3px] md:py-[2px] xl:py-1 text-[#464646] md:text-[12px] lg:text-[14px] xl:text-[15px] bg-white hover:bg-[#9C834E] hover:text-white duration-200 self-start">
                <p>view more</p>
                <i
                    class="fa-solid fa-play text-[10px] md:text-[8px] lg:text-[9px] lg:text-[10px] pt-[2px] lg:pt-[2px] xl:pt-[2px]">
                </i>
...
<section
    ...
    <h1 class="md:hidden block text-white text-left text-[22px] mb-8">
        The Story of <span class="text-[50px]">AMA</span>
        ...
        <div class="flex-1">
            <div class="flex flex-col items-center md:items-start gap-8 lg:gap-12 xl:gap-16 lg:w-2/3">
                <h1
                    ...
                    The Story of <span class="text-[30px] md:text-[40px] lg:text-[40px] xl:text-[70px]">AMA</span>
                ...
                <div
                    ...
                    In the waters of Ise-Shima, a living tradition has
                    endured for 3,000 years. The Ama, female free
                    divers who gather the ocean’s bounty, are a
                    National Living Treasure. Their sustainable
                    fishing methods are guided by an ancient
                    wisdom and a profound respect for the sea,
                    ensuring its resources are never depleted.
                    MIEscape offers respectful opportunities to dive
                    and converse with these remarkable women.
                    Your journey becomes a vital link in preserving
...
<section
    ...
    <div class="w-full max-w-[1000px] mx-auto flex flex-col gap-14 items-center mb-12">
        <div class="flex flex-col gap-4 xl:gap-6 w-full mb-4">
            <h1 class="font-garamond text-white text-[30px] md:text-[30px] lg:text-[35px] xl:text-[45px]">Discover Ise-Shima</h1>
            <hr>
        ...
        <div class="w-full flex flex-col xl:gap-40 lg:gap-32 gap-24">
            <div class="flex md:flex-row flex-col items-center w-full gap-7 md:gap-10">
                ...
                <div class="flex-1 flex flex-col gap-10">
                    <p
                        ...
                        Mie Prefecture is located near the geographical center of Japan,
                        boasting exceptional access to the major metropolitan areas of
                        the Tokai region (Nagoya) and the Kansai region (Osaka and Kyoto).
                    </p>
                    <div class="w-full flex flex-row justify-end md:justify-start">
                        <a href="<?php echo esc_url(home_url('en/about?access')); ?>"
                            class="inline-flex items-center gap-3 px-2 md:px-2 font-bold lg:px-3 xl:px-4 xl:pb-1 xl:mt-[1px] text-[#464646] md:text-[12px] lg:text-[14px] xl:text-[17.5px] bg-white hover:bg-[#9C834E] hover:text-white duration-200 self-start tracking-[2px] fong-garamond">
                            <p>access</p>
                            <i
                                class="fa-solid fa-play text-[10px] md:text-[8px] lg:text-[9px] lg:text-[10px] pt-[2px] lg:pt-[3px] xl:pt-[4px]"></i>
                        </a>
                    </div>
                </div>
            </div>
            <div class="flex flex-col xl:gap-20 lg:gap-16 md:gap-12 gap-8">
                ...
                <div class="w-full flex flex-col xl:gap-32 lg:gap-24 gap-8 justify-center items-center">
                    ...
                    <a href="<?php echo esc_url(home_url('/en/about')); ?>"
